...
contract BaseERC721 {
    ...
    constructor(
        ...
        string memory baseURI_ // baseURI is the URI for the token metadata
    ) {
        _name = name_;
        _symbol = symbol_;
        _baseURI = baseURI_;
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(owner == msg.sender, "ERC721: approval to current owner");
    ...
    function setApprovalForAll(address operator, bool approved) public {
        ...
        require(sender == ownerOf(tokenId), "ERC721: approve to caller");
